<script lang="ts">
	...
	let choiceList: string[] = ['ล่าสุด', 'ปี 2567', 'ปี 2566', 'ปี 2565', 'ปี 2564', 'ปีย้าวยาวววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววววว'];
</script>
